...
| `immutable_field` | Reserved | 400 | Reserved for future endpoints. ACDP v0.0.1 defines no endpoint that mutates a body field; this code is reserved for v0.1+ retraction/attestation extensions. | [RFC-ACDP-0009 §2.1](../rfcs/RFC-ACDP-0009-extensions.md#21-retraction--lifecycle-events) |
