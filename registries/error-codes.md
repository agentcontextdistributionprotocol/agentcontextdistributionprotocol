...
| `not_implemented` | Stable | 501 | The requested endpoint or capability is not implemented by this registry. Returned with the standard error envelope (RFC-ACDP-0007 §4). | [RFC-ACDP-0007 §4](../rfcs/RFC-ACDP-0007-capabilities.md#4-error-envelope) |
