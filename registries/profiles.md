...
| `acdp-registry-receipts` | Optional (0.2.0, Draft) | RFC-ACDP-0010 §11, RFC-ACDP-0001 §9.1 | `acdp-registry-core`, `acdp_version` ≥ 0.2.0 |
| `acdp-registry-head-receipts` | Optional (0.3.0, Draft) | RFC-ACDP-0011 §9, RFC-ACDP-0001 §9.1 | `acdp-registry-receipts`, `acdp_version` ≥ 0.3.0 |
| `acdp-registry-lifecycle` | Optional (0.3.0, Draft) | RFC-ACDP-0013 §10, RFC-ACDP-0001 §9.1 | `acdp-registry-core`, `acdp_version` ≥ 0.3.0 |
...
### `acdp-registry-head-receipts` *(0.3.0, Draft)*
...
### `acdp-registry-lifecycle` *(0.3.0, Draft)*
...
Reserved future identifiers: `acdp-registry-push` (RFC-ACDP-0009 §2.4), `acdp-registry-walks` (RFC-ACDP-0009 §2.5), `acdp-registry-transparency-log` (RFC-ACDP-0009 §2.11). (`acdp-registry-receipts` was promoted out of reserved space by RFC-ACDP-0010 in acdp/0.2.0.)
