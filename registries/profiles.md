...
| `acdp-registry-transparency-log` | Optional (0.3.0, Draft) | RFC-ACDP-0012 §11, RFC-ACDP-0001 §9.1 | `acdp-registry-receipts`, `acdp_version` ≥ 0.3.0 |
...
### `acdp-registry-transparency-log` *(0.3.0, Draft)*
