...
| [RFC-ACDP-0002](RFC-ACDP-0002-context-body.md) | Context Body | Final (0.1.0); 0.3.0 amendment Draft |
| [RFC-ACDP-0003](RFC-ACDP-0003-publish.md) | Publish & Supersession | Final (0.1.0); 0.2.0/0.3.0 amendments Draft |
| [RFC-ACDP-0004](RFC-ACDP-0004-retrieval.md) | Retrieval & Lineage | Final (0.1.0); 0.2.0/0.3.0 amendments Draft |
| [RFC-ACDP-0005](RFC-ACDP-0005-discovery.md) | Discovery (keyword search) | Final (0.1.0); 0.3.0 amendment Draft |
...
| [RFC-ACDP-0009](RFC-ACDP-0009-extensions.md) | Extensions (attestations, walks, push, log) | Reserved (§2.7 promoted to RFC-ACDP-0010; §2.1 promoted to RFC-ACDP-0013) |
| [RFC-ACDP-0010](RFC-ACDP-0010-registry-receipts.md) | Registry Receipts | Draft (acdp/0.2.0) |
| [RFC-ACDP-0011](RFC-ACDP-0011-lineage-head-receipts.md) | Lineage-Head Receipts | Draft (acdp/0.3.0) |
| [RFC-ACDP-0013](RFC-ACDP-0013-lifecycle-events.md) | Lifecycle Events & Retraction | Draft (acdp/0.3.0) |
| [RFC-ACDP-0014](RFC-ACDP-0014-key-revocation.md) | Producer Key-Revocation Signal | Draft (acdp/0.3.0) |
## Reading order
...
11. **[RFC-ACDP-0013 Lifecycle Events & Retraction](RFC-ACDP-0013-lifecycle-events.md)** *(0.3.0, Draft)* — signed, append-only lifecycle events in registry state; producer/registry retraction and republication; the `retracted` status (dominating `superseded`/`expired`); mark-not-delete throughout. Promotes RFC-ACDP-0009 §2.1.
12. **[RFC-ACDP-0014 Producer Key-Revocation Signal](RFC-ACDP-0014-key-revocation.md)** *(0.3.0, Draft)* — the normative `key-revocation` context type and time-scoped verification boundary: receipt-attested publish times before `compromised_since` stay historically authorized; at/after (or unverifiable) fail closed.
Reserved (no normative text, numbering pinned for future work):

- **[RFC-ACDP-0009 Extensions](RFC-ACDP-0009-extensions.md)** — post-publication relationships, attestations, push subscriptions, server-side traversal, transparency log.
