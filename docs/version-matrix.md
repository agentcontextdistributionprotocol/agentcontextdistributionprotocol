...
| **v0.4.0 Witness Cosigning** | **Draft** (opened 2026-07-05) — RFC-ACDP-0015 (transparency-log witness cosigning), promoting the RFC-ACDP-0009 §2.12 reservation | `0.5.3+` (current: crates.io `acdp 0.8.1`; npm bindings 0.8.0, PyPI `acdp` 0.7.0) | current `main` aggregates witness cosignatures (`witness_signatures` on checkpoints) | v0.3.0 profiles + `acdp-log-witness` (a witness node, not a registry) |
