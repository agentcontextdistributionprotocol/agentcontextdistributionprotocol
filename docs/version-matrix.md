...
- `0.5.x` (crates.io `acdp 0.5.0`, current) implements the spec v0.2.0 + v0.3.0 Final surface: require-mode conformance passes 61/61 fixtures, including the executed `rcpt`/`lhr`/`log`/`rev` bindings.
...
- Pinning a library? `acdp = "0.1"` gives you frozen v0.1.0 semantics; `0.2`/`0.3` carry the v0.2.0 surface; `0.5` carries the v0.2.0 + v0.3.0 Final surface.
